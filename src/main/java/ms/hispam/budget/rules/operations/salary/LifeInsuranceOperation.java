...
import ms.hispam.budget.rules.operations.MediatorWithBirthDate;
import ms.hispam.budget.rules.operations.Operation;
import ms.hispam.budget.rules.operations.OperationWithBirthDate;

import java.time.LocalDate;
import java.util.List;
import java.util.Map;

public class LifeInsuranceOperation implements Operation  {
    @Override
